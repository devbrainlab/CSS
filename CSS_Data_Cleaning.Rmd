...
netcanvas_cleaned <- netcanvas_cleaned  %>% add_column(unique_friends = NA, .after = "names")
netcanvas_cleaned <- netcanvas_cleaned  %>% add_column(common_friends = NA, .after = "unique_friends")
