...
#Model H2
    ...
    total_minutes_mspss<-round(seq(min(mspss_analysis$final_total_min_cw2,na.rm = TRUE),
                                    max(mspss_analysis$final_total_min_cw2,na.rm = TRUE),by=400),2)
                 data.pred = data.frame(final_total_min_cw2=total_minutes_mspss)
                 ...
                 #assign(paste0("abslinedplot_",meas),
                        ggplot(data=NULL#,
                          ...
                          geom_point(data=mspss_analysis,
                                     aes(x=final_total_min_cw2, y=mspsss_total_cw2,group=record_id,colour=wave),
                                     size=1.5,
                                     alpha=0.5) +
                          geom_line(data=data.pred, #predicted data
                                    aes(x=final_total_min_cw2, y=y.pred), #y.pred as x?
