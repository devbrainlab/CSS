...
data = analysis_data, geom = "line", main= "Participants by Wave",xlab="Wave", ylab="Participant")  + theme(legend.position="none")
ggsave("ParticipantWave.png")

qplot(x=StartDate, y=record_id, colour = factor(record_id),
data = analysis_data, geom = "line", main= "Participants by Date",xlab="Date", ylab="Participant")  + theme(legend.position="none")
