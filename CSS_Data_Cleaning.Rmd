...
#Plot variable over waves, mean for each age group
#aggregate
...
#Basic model testing
test_model_min <- lme(mspss_total ~ final_social_min, random=~1|record_id, data=analysis_data,na.action=na.omit)
summary(test_model_min)

test_model_prop <- lme(mspss_total ~ final_social_prop, random=~1|record_id, data=analysis_data,na.action=na.omit)
summary(test_model_prop)
```
